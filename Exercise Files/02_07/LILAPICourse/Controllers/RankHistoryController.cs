...
namespace LILAPICourse.Controllers
{
    ...
    public class RankHistoryController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<RankHistoryViewModelV2>>> RankHistoryV2([FromRoute] Guid productId)
        {
            return await _context.RankHistory.Where(z => z.ProductId == productId).Select(rank => new RankHistoryViewModelV2
            {
                Id = rank.Id,
                Date = rank.Date,
